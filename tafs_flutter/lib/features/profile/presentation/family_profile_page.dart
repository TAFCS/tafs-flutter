      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppTheme.space6),
            _SheetDetailItem(icon: Icons.phone_rounded, label: 'Phone', value: guardian.composedPhone() ?? 'N/A'),
            _SheetDetailItem(icon: Icons.chat_bubble_rounded, label: 'WhatsApp', value: guardian.composedPhone(whatsapp: true) ?? 'N/A'),
